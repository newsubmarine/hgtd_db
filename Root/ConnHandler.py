...
from utils.config_utils import HGTD_config
...
class ConnHandler():
	...
	def __init__(self,Config):
		...
		if not self.get_engine_string or self.db_config.server and not re.match(r'lxplus\d{3}.cern.ch',os.popen("hostname").read()):
			self.connect_ssh()
